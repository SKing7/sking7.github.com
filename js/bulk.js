...
+			    '<a id="sidebar_menu__speak" title="' + __escapeForHTML($R.translate('menu__speak__tooltip')) + (($R.vars && $R.vars['keys_speech'] > '') ? ' (' + __escapeForHTML($R.vars['keys_speech']) + ')' : '') + '" href="#"></a>'
+			    '<a id="sidebar_menu__speak_initializing" title="' + __escapeForHTML($R.translate('menu__speak__tooltip')) + '" href="#"><div id="sidebar_menu__speak_initializing_spinner"></div></a>'
            

            
+           '<div id="sidebar_menu__speak_section">'
+			    '<a id="sidebar_menu_speak__play" title="' + __escapeForHTML($R.translate('menu__speak__play__tooltip')) + (($R.vars && $R.vars['keys_speech'] > '') ? ' (' + __escapeForHTML($R.vars['keys_speech']) + ')' : '') + '" href="#"></a>'
+			    '<a id="sidebar_menu_speak__pause" title="' + __escapeForHTML($R.translate('menu__speak__pause__tooltip')) + (($R.vars && $R.vars['keys_speech'] > '') ? ' (' + __escapeForHTML($R.vars['keys_speech']) + ')' : '') + '" href="#"></a>'
+			    '<a id="sidebar_menu_speak__loading" title="' + __escapeForHTML($R.translate('menu__speak__tooltip')) + '" href="#"><div id="sidebar_menu_speak__loading_spinner"></div></a>'
+			    '<a id="sidebar_menu_speak__forward" title="' + __escapeForHTML($R.translate('menu__speak__forward__tooltip')) + '" href="#"></a>'
+			    '<a id="sidebar_menu_speak__rewind" title="' + __escapeForHTML($R.translate('menu__speak__rewind__tooltip')) + '" href="#"></a>'
+           '</div>'
...
+				    '<iframe class="secureFrame" id="login_frame" name="login_frame" scrolling="no" frameborder="0" src="'+$R.paths['main']+'frames/login.html'+'"></iframe>'
...
+			'<div class="dialog dynamic" id="dialog__speech"><div class="dialog_canvas theFont">'
+               '<div id="dialog__speech__content" class="needLogin">'
+                   '<table id="dialog__speech__table" cellspacing="0" cellpadding="0" border="0">'
+                   '<tr id="dialog__speech__speech">'
+                       '<td class="image"><div class="feature_image"></div></td>'
+                       '<td class="text">'
+                           '<div id="dialog__speech__frame_container">'
+                               '<div class="feature_text">'
+                                   '<h6>' + __escapeForHTML($R.translate('features__speech__title')) + '</h6>'
+                                   '<p>'  + __escapeForHTML($R.translate('features__speech__text')) + '</p>'
+                                   '<h6>' + __escapeForHTML($R.translate('features__speech__text__available')) + '</h6>'
+                                   '<p>'  + __escapeForHTML($R.translate('features__speech__text__available_languages')) + '</p>'
+                               '</div>'
+                               '<div id="dialog__speech__frame_div"><iframe frameborder="0" allowtransparency="true" scrolling="no"></iframe></div>'
+                           '</div>'
+                           '<div id="dialog__speech__notice"><p>'  
+                               __escapeForHTML($R.translate('features__speech__text__powered')).replace('[=service]', 'iSpeech <a href="http://www.ispeech.org/text.to.speech" target="_blank">Text To Speech</a>') + '<br/>'
+                               __escapeForHTML($R.translate('features__speech__text__requires')).replace('[=product]', '<a href="http://get.adobe.com/flashplayer/" target="_blank">Flash Player</a>') 
+                           '</p></div>'
+                           '<div id="dialog__speech__buttons">'
+                               '<div id="dialog__speech__spinner"></div>'
+                               '<a id="dialog__speech__try" href="#" class="dialogButton theFont">' + __escapeForHTML($R.translate('features__speech__text__try')) + '</a>'
+                               '<a id="dialog__speech__upgrade" href="#" class="dialogButton theFont">' + __escapeForHTML($R.translate('features__speech__text__upgrade')) + '</a>'
+                               '<a id="dialog__speech__login" href="#" class="dialogButton theFont">' + __escapeForHTML($R.translate('evernote_login__button_do__label')) + '</a>'
+                               '<a id="dialog__speech__flash" href="http://get.adobe.com/flashplayer/" target="_blank" class="dialogButton theFont">' + __escapeForHTML($R.translate('features__speech__text__requires')).replace('[=product]', 'Flash Player') + '</a>'
+                               '<a id="dialog__speech__language" href="#" class="dialogButton theFont">' + __escapeForHTML($R.translate('features__speech__text__language')) + '</a>'
+                           '</div>'
+                       '</td>'
+                   '</tr>'
+                   '</table>'
...
+			'<div class="dialog dynamic" id="dialog__speech_language"><div class="dialog_canvas theFont">'
+               '<div id="dialog__speech_language__content" class="needLogin">'
+                   '<table id="dialog__speech_language__table" cellspacing="0" cellpadding="0" border="0">'
+                   '<tr id="dialog__speech_language__speech">'
+                       '<td class="image"><div class="feature_image"></div></td>'
+                       '<td class="text">'
+                           '<div class="feature_text">'
+                               '<h6>' + __escapeForHTML($R.translate('features__speech__title')) + '</h6>'
//+                               '<p>'  + __escapeForHTML($R.translate('features__speech__no_language_title')) + '</p>'
+                               '<p>'  + __escapeForHTML($R.translate('features__speech__no_language_explanation')) + '</p>'
+                               '<p>'  + '<select id="dialog__speech_language__select"></select>' + '</p>'
+                           '</div>'
+                           '<div id="dialog__speech_language__buttons">'
+                               '<a id="dialog__speech_language__play" href="#" class="dialogButton theFont">' + __escapeForHTML($R.translate('features__speech__text__play')) + '</a>'
+                               '<a id="dialog__speech_language__cancel" href="#" class="dialogButton theFont">' + __escapeForHTML($R.translate('features__speech__text__cancel')) + '</a>'
+                           '</div>'
+                       '</td>'
+                   '</tr>'
+                   '</table>'
...
+                   '<tr id="dialog__features__speech">'
+                       '<td class="image"><div class="feature_image"></div></td>'
+                       '<td class="text">'
+                           '<div class="feature_title">' + __escapeForHTML($R.translate('features__speech__title')) + '</div>'
+                           '<div class="feature_text">'
+                               __escapeForHTML($R.translate('features__speech__text')) + '<br /><br />'
+                               __escapeForHTML($R.translate('features__speech__text__powered')).replace('[=service]', 'iSpeech <a href="http://www.ispeech.org/text.to.speech" target="_blank">Text To Speech</a>') + '<br />'
+                               __escapeForHTML($R.translate('features__speech__text__requires')).replace('[=product]', '<a href="http://get.adobe.com/flashplayer/" target="_blank">Flash Player</a>')
+                           '</div>'
+                      '</td>'
...
//  ===========
    ...
    var _iframeHTML__speech = ''
        ...
        +		'<link rel="stylesheet" href="'+$R.paths['main']+'css/'+$R.versioning['file_name_base--theme-1_css']+'" type="text/css" />'
        +		'<style type="text/css">'
        
        +           'body, html     { overflow: hidden; background-color: #F3F2EE; } '
        +			'#background	{ position: fixed; top: 0; left: 0;	width: 100%; height: 100%; z-index: 10; } '
        +			'#box 			{ padding: 0; margin: 0; position: relative; z-index: 20; } '
        +			'#box_inner 	{ position: relative; margin: 0; } '
        +			'#text 			{ padding: 0.5em !important; } '
        ...
        +           '} '
        +           'h6 { font-size: 100%; font-weight: bold; margin: 0 !important; } '
        +           'p { margin: 0 !important; margin-bottom: 1em !important; } '

        +           '#text div.page_duplicateForSpeech #nowSpeaking span { color: #454545; } '
        ...
        +		'<script type="text/javascript" src="'+$R.paths['main']+'options/bulk__forSpeechDemo.js"></script>'
        +	'</body>'
        +	'</html>'
    ;
    ...
    //  separatos
    //  =========
        _iframeHTML__speech = _iframeHTML__speech.replace(/<\/(h6|p)>/gi, '<b class="speechFragmentSeparator">&nbsp;</b></$1>');
        _iframeHTML__speech = _iframeHTML__speech.replace(/<h6>(.)/i, '<h6><b class="speechFragmentSeparator">$1</b>');
    ...
    //  write
    //  =====
        $R.afterShowRunThese.push(function () 
        {
            window.setTimeout(function () 
            {
                //  write
                    $R.__speech_demo_document = $('#dialog__speech__frame_div iframe').contents().get(0);
                    $R.__speech_demo_document.open();
                    $R.__speech_demo_document.write(_iframeHTML__speech);
                    $R.__speech_demo_document.close();
                
                //  after demo frame load
                    window.setTimeout(function ()
                    {
                    
                        //  add IDs to fragment separators
                        //  ==============================
                            $($R.__speech_demo_document).find('div.page_content b.speechFragmentSeparator')
                                .each(function (_i, _e)
                                {
                                    $(_e).attr(
                                        'id', 
                        ...
                        //  add second timer -- also, remove scrolling
                        //  ================
                            (function ($R)
                            {
                                $R.speech__doAutoScroll = function () { return false; }

                                var _s = $R.speech__onStartPlaying, _e = $R.speech__onEndPlaying;
                                $R.speech__onStartPlaying = function () { _s(); document.getElementById('dialog__speech__buttons').className = 'speakPlaying'; };
                                $R.speech__onEndPlaying = function () { _e(); document.getElementById('dialog__speech__buttons').className = 'speakPaused'; };
                            }
                            )(window.$readableForSpeechDemo);
    ...
    //  ============
        ...
        $('#sidebar_menu__print').click(function() {                    return $R.menu_functions['print'](); });
            ...
            $('#sidebar_menu__speak').click(function() {                    return $R.menu_functions['speak'](); });
            $('#sidebar_menu_speak__play').click(function() {               return $R.menu_functions['speak__play'](); });
            $('#sidebar_menu_speak__pause').click(function() {              return $R.menu_functions['speak__pause'](); });
            $('#sidebar_menu_speak__forward').click(function() {            return $R.menu_functions['speak__forward'](); });
            $('#sidebar_menu_speak__rewind').click(function() {             return $R.menu_functions['speak__rewind'](); });
            $('#sidebar_menu_speak__loading').click(function() {            return $R.menu_functions['speak__loading'](); });
    ...
    //  =============
        ...
        $R.menu_functions['highlighting_to_evernote'] = function () { };
            ...
            $R.menu_functions['speak'] = function () { };
            $R.menu_functions['speak__play'] = function () { };
            $R.menu_functions['speak__pause'] = function () { };
            $R.menu_functions['speak__forward'] = function () { };
            $R.menu_functions['speak__rewind'] = function () { };
            $R.menu_functions['speak__loading'] = function () { };
    ...
    //  ======
            ...
            $R.menu_functions['speak'] = function ()
            {
                ...
                $R.customEvents.dispatchByName('to-extension--evernote--speech-start');
                return false;
            };
        
            $R.menu_functions['speak__play'] = function () { $R.speech__doPlay(); return false; };
            $R.menu_functions['speak__pause'] = function () { $R.speech__doPause(); return false; };
            $R.menu_functions['speak__forward'] = function () { $R.speech__doForward(); return false; };
            $R.menu_functions['speak__rewind'] = function () { $R.speech__doRewind(); return false; };
            $R.menu_functions['speak__loading'] = function () { return false; };
	...
	*/
    ...
    //  =============
		...
		switch (_event_name)
		{
			...
			case 'to-browser--evernote--get-recommendation--successful':
                ...
                case 'to-browser--evernote--speech--go':
                    //  track
                    $R.customEvents.dispatchByName('to-extension--track--speech-start');

                    //  detect flash
                    $R.speech__doDetectFlashAndPlay();
                    break;
			...
			case 'to-browser--show--dialog-first--new-features':
                ...
                case 'to-browser--show--dialog-speech--need-login':
                    //  stop initializing
                    $R.$html.removeClass('speakInitializing');
            
                    //  need login
                    $('#dialog__speech__content').removeClass('needFlash needPremium noLanguage').addClass('needLogin');
                ...
                case 'to-browser--show--dialog-speech--need-premium':
                    //  stop initializing
                    $R.$html.removeClass('speakInitializing');
            
                    //  need premium
                    $('#dialog__speech__content').removeClass('needFlash needLogin noLanguage').addClass('needPremium');
    ...
    $R.speech__instanceEvent__updatePlayhead = function (_instanceIndex, _percentPlayed, _playedToThisTime)
    {
        ...
        //  ====================
            if ((_instanceIndex != $R.speech__posSpeaking__instance) && !(_instance['played']))
            {
        ...
        //  =====================
            ...
            if (_marker_word == false); else
            {
                ...
                //  make sure it's gone
                //  ===================
                    $R.$box.find('#nowSpeaking').addClass('formerlyNowSpeaking').attr('id', '');
    ...
    $R.speech__errorsMax__tryPlay = 3;
    $R.speech__errorsMax__loadAudio = 3;
    $R.speech__errorsMax__loadMarkers = 3;
    ...
    $R.speech__instanceEvent__tryPlay = function (_instanceIndex)
    {
        ...
        //  =========
            ...
            //  stop? skip to next
                if (_instance['errorCount__play'] > $R.speech__errorsMax__tryPlay)
                {
                    $R.speech__instanceEvent__trackEnded(_instanceIndex);
                    return;
                }
    ...
    $R.speech__instanceEvent__loadError__audio = function (_instanceIndex)
    {
        ...
        //  stop?
            if (_instance['errorCount__audio'] > $R.speech__errorsMax__loadAudio) { return; }
    ...
    $R.speech__instanceEvent__loadError__markers = function (_instanceIndex)
    {
        ...
        //  stop?
            if (_instance['errorCount__markers'] > $R.speech__errorsMax__loadMarkers) { return; }
	...
	*/
		...
		if ((_key_code != 'Escape') && (_key_code == _key_combo))
		{
			...
			switch (true)
			{
				...
				case ($R.vars && (_key_combo == $R.vars['keys_clip'])):
                    ...
                    //	pause speaking
                    case ($R.vars && (_key_combo == $R.vars['keys_speech']) && ($R.$html.hasClass('speakPlaying'))):
                        $R.menu_functions['speak__pause'].call();
                        _stop = true;
                        break;

                    //	resume speaking
                    case ($R.vars && (_key_combo == $R.vars['keys_speech']) && ($R.$html.hasClass('speakPaused'))):
                        $R.menu_functions['speak__play'].call();
                        _stop = true;
                        break;
                    
                    //	nothing
                    case ($R.vars && (_key_combo == $R.vars['keys_speech']) && ($R.$html.hasClass('speakInitializing'))):
                        _stop = true;
                        break;

                    //	first speak
                    case ($R.vars && (_key_combo == $R.vars['keys_speech'])):
    ...
    //  =======
        ...
        //  ======
            ...
            $('#dialog__speech__language, #dialog__speech_language__cancel').click(function ()
            {
                $R.hideOpenDialog();
                return false;
            });

            $('#dialog__speech__try').click(function ()
            {
                //  loading
                $('#dialog__speech__buttons').addClass('speakLoading');
                ...
                (function ($R) {
                    ...
                    //  play
                    window.$readableForSpeechDemo.speech__doInitAndPlay();
            ...
            $('#dialog__speech__upgrade').click(function ()
            {
                $R.customEvents.dispatchByName('to-extension--open--premium');
                return false;
            });
            
            $('#dialog__speech__login').click(function ()
            {
				//	clear login
                ...
                //  requested for
                $R.evernoteLogin__requestedFor = 'speech';
                $('#dialog__clip__login').attr('requested_for', $R.evernoteLogin__requestedFor);
                $('#dialog__clip__login_reset').attr('requested_for', $R.evernoteLogin__requestedFor);
            ...
            $('#dialog__speech_language__play').click(function ()
            {
                //  close
                $R.hideOpenDialog();
                
                //  language
                var _l = { 'data': { 'detections': [ [ { 'language': $('#dialog__speech_language__select').val() } ] ] } };
                
                //  play
                $R.speech__doInitAndPlay_go(_l);
            ...
            (function () {
                ...
                //  get
                var _langs = $R.speech__voices;
                
                //  remove unsupported
                for (var _l in _langs) { if (_langs[_l].u) { delete _langs[_l]; } }
            
                //  add
                for (var _l in _langs) { $('#dialog__speech_language__select').append('<option value="'+_l+'">' + _langs[_l].n + '</option>'); }
